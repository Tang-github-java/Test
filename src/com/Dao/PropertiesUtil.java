...
public final class PropertiesUtil {
	...
	public static String getValue(String key) throws IOException {
		...
		// 根据属性文件的名称得到属性文件路径
		String filePath = PropertiesUtil.class.getClassLoader().getResource("abc.properties").getPath();// jdbc.properties属性文件的名称
